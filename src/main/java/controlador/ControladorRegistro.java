			...
			try {
				 JTextArea textArea = new JTextArea(25, 50);
			      textArea.setText( "CONDICIONES DE USO\r\n" + 
			      		...
			      		"\r\n" + 
			      		"Los términos y condiciones que contiene el presente documento regulan el acceso y uso de la Web www.viajesSAMISA.com , (en adelante viajeszeppelin.com o el sitio Web)\r\n" + 
			      		"\r\n" + 
